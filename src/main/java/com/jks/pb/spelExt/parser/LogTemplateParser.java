package com.jks.pb.spelExt.parser;
...
import com.jks.pb.spelExt.ops.SelfFunctionReference;
import com.jks.pb.spelExt.token.Token;
import com.jks.pb.spelExt.token.TokenKind;
import com.jks.pb.spelExt.token.Tokenizer;

import java.util.*;
import java.util.regex.Pattern;


public class LogTemplateParser extends TemplateAwareExpressionParser {
     ...
     */
    public LogTemplateParser(SpelParserConfiguration configuration) {
    ...
    private SpelNodeImpl eatStartNode() {
        ...
        else if (maybeEatSelfFunctionReference()) {
            return pop();
        }
